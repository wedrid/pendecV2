...
class DFPenaltyDecomposition:
    ...
    def startWithBRestart(self):
        self.start()
        secondPD = DFPenaltyDecomposition(self.fun, tau_zero=1, x_0=self.resultPoint, gamma=1.1, save=False, l0_constraint=self.l0_constraint)
        secondPD.start()
        self.minPoint = secondPD.minPoint
        self.minVal = secondPD.minVal
        self.resultPoint = secondPD.resultPoint
        self.resultVal = secondPD.resultVal
